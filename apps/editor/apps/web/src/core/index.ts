...
import { RemoteClipsManager } from "./managers/remote-clips-manager";
...
export class EditorCore {
	...
	public readonly remoteClips: RemoteClipsManager;
	...
	private constructor() {
		...
		this.remoteClips = new RemoteClipsManager(this);
